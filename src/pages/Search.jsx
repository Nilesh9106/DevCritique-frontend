        ...
        <>
            ...
            {!loading && <div className=" mx-auto lg:w-[60%] px-2 sm:w-3/4 w-full flex flex-col justify-center items-center  pb-2">
                {projects.map((project, index) => {
                    ...
                    }} setLoading={setLoading} _id={project._id} author={project.author[0]} link={project.link} description={project.description} ogDetails={project.ogDetails} technologies={project.technologies} like={project.like} likeCount={project.likeCount} createdAt={project.createdAt} images={project.images} />
                })}
            </div>}
        </>
    )
